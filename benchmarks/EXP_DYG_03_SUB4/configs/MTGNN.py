...
from basicts.metrics import masked_mae, masked_mape, masked_mse, masked_rmse, masked_wape
...
if buildA_true: # self-learned adjacency matrix
    ...
    _, adj_mx = load_adj("/home/home_new/qsmx/pycodes/BasicTS/datasets/" + DATA_NAME +
