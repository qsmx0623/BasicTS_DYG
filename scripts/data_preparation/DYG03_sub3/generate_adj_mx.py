...
def generate_adj_dyg03():
    distance_df_filename, num_of_vertices = "/home/home_new/qsmx/pycodes/BasicTS/datasets/raw_data/DYG_data_3_sub3/sub3_casualgraph.csv", 5
    ...
    with open("/home/home_new/qsmx/pycodes/BasicTS/datasets/raw_data/DYG_data_3_sub3/adj_DYG_data_3_sub3.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("/home/home_new/qsmx/pycodes/BasicTS/datasets/raw_data/DYG_data_3_sub3/adj_DYG_data_3_sub3_distance.pkl", "wb") as f:
