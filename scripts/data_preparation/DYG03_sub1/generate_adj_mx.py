        ...
        if id_filename:
            ...
            with open(distance_df_filename, "r") as f:
                ...
                for row in reader:
                    ...
                    # Set only (i, j) since it is a directed graph
...
def generate_adj_dyg03():
    distance_df_filename, num_of_vertices = "/home/home_new/qsmx/pycodes/BasicTS/datasets/raw_data/DYG_data_3_sub1-3/sub1_casualgraph.csv", 5
    ...
    with open("/home/home_new/qsmx/pycodes/BasicTS/datasets/raw_data/DYG_data_3_sub1-3/adj_DYG_data_3_sub1-3.pkl", "wb") as f:
        pickle.dump(adj_mx, f)
    with open("/home/home_new/qsmx/pycodes/BasicTS/datasets/raw_data/DYG_data_3_sub1-3/adj_DYG_data_3_sub1-3_distance.pkl", "wb") as f:
