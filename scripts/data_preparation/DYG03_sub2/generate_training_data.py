...
from generate_adj_mx import generate_adj_dyg03 as generate_adj

# Hyperparameters
dataset_name = 'DYG_data_3_sub2-3'
data_file_path = f'/home/home_new/qsmx/pycodes/BasicTS/datasets/raw_data/{dataset_name}/{dataset_name}.csv'
graph_file_path = f'/home/home_new/qsmx/pycodes/BasicTS/datasets/raw_data/{dataset_name}/adj_{dataset_name}.pkl'
output_dir = f'/home/home_new/qsmx/pycodes/BasicTS/datasets/{dataset_name}'
...
domain = 'bio_factor_sub2'
feature_description = [domain, 'add_time_of_day', 'add_day_of_week', 'add_day_of_month', 'add_day_of_year']
regular_settings = {
    'INPUT_LEN': 12,
    'OUTPUT_LEN': 12,
...
def load_and_preprocess_data():
    ...
    df = df.iloc[:150*30*24]
    df_index = pd.to_datetime(df['date'].values, format='%Y/%m/%d %H:%M').values
    df = df[df.columns[1:]]
