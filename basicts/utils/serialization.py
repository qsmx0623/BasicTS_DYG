...
def load_dataset_desc(dataset_name: str) -> str:
    ...
    # read json file: datasets/dataset_name/desc.json
    with open(f'/home/home_new/qsmx/pycodes/BasicTS/datasets/{dataset_name}/desc.json', 'r') as f:
        desc = json.load(f)
    return desc
...
def load_dataset_data(dataset_name: str) -> np.ndarray:
    ...
    dat_file_path = f'/home/home_new/qsmx/pycodes/BasicTS/datasets/{dataset_name}/data.dat'
